/**
 * Terms of Use for contributor.info GitHub App
 */

export const TERMS_OF_USE = `
# Terms of Use - contributor.info GitHub App
...
- Email: privacy@contributor.info
...
export function getTermsOfUseMarkdown(): string {
  return TERMS_OF_USE;
}
