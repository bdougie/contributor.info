...
export function formatMinimalPRComment(data: CommentData): string {
  const { contributorInsights, reviewerSuggestions, similarIssues, config } = data;
...
---
*This comment was generated by contributor.info - providing contributor insights and reviewer suggestions. [Install on your repositories](https://github.com/apps/contributor-info)*`;
}
