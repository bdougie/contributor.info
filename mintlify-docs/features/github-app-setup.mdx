...
description: Get 10× faster similarity search across all your issues, automatic real-time PR analysis, and zero API rate limits by installing the contributor.info GitHub App.
---
...
### 🚀 **10× Faster Similarity Searches**
- **Before**: 2-3 second wait for on-demand API calls
- **After**: Under 500ms using pre-computed embeddings
...
**Yes**, you can uninstall anytime from [GitHub settings](https://github.com/settings/installations). Your data will be removed according to our data retention policy.
...
4. 🚀 **Explore features** - Browse the features documentation for more capabilities
...
- [Repository Documentation](https://github.com/bdougie/contributor.info/tree/main/docs) - Additional technical details

## Support

Need help? We're here for you:

- 📖 **Documentation**: Browse [repository docs](https://github.com/bdougie/contributor.info/tree/main/docs)
