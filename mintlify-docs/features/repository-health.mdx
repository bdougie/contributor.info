...
Illustrative example — actual score bands depend on your repository's metrics.

For example, a repository might show a **Health Score of 58** (yellow):
...
- Increasing active contributor coverage can help improve the overall health score.
