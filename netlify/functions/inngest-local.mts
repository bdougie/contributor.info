...
const inngestHandler = serve({
  client: inngest,
  functions: [testFunction, capturePrDetailsLocal, syncRepositoryLocal],
      ...
      JSON.stringify(
        {
          ...
          instructions: {
            inngestDev:
              'Run: npx inngest-cli@latest dev -u http://localhost:8888/.netlify/functions/inngest-local',
            testEvent:
              'Send test event: { "name": "test/local.hello", "data": { "message": "Hello!" } }',
          },
        },
        null,
        2
