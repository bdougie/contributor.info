...
// This provides the /inngest-sync endpoint that Inngest expects
// while reusing all logic from inngest-prod
...
console.log('Inngest Sync Configuration:', {
  ...
  endpoint: 'inngest-sync'
});

// Test function to verify connection
const testFunction = inngest.createFunction(
  { id: "sync-test-function" },
  { event: "test/sync.hello" },
  async ({ event, step }) => {
    console.log("Sync test function executed!", event);
    ...
    return {
      message: "Hello from Inngest Sync!",
