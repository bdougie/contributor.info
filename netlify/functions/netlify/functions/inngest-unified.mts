      ...
      JSON.stringify(
        {
          ...
          functions: [
            ...
            { id: 'capture-repository-discussions', event: 'capture/repository.discussions' },
          ...
          usage: {
            ...
            syncEvent:
              'Send: { "name": "capture/repository.sync.graphql", "data": { "repositoryId": "123", "days": 30 } }',
            classifyEvent:
              'Send: { "name": "classify/repository.single", "data": { "repositoryId": "123", "owner": "owner", "repo": "repo" } }',
          },
        },
        null,
        2
