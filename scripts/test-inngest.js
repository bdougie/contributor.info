...
const inngest = new Inngest({ 
  id: "contributor-info",
  isDev: true,
  eventKey: process.env.INNGEST_EVENT_KEY || "test_gMxyJRNyQOy2UYpMidaLhrADUYZYELRdq4zL5xgU3KGVfyLb"
});
...
async function testInngest() {
  ...
  try {
    ...
    console.error("3. Ensure the Inngest endpoint is accessible at http://127.0.0.1:8888/.netlify/functions/inngest");
  }
}
