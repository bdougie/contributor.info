 ...
 *
 * Usage:
 *   node scripts/testing-tools/test-backfill-endpoints.js [base-url]
 *
 * Examples:
 *   node scripts/testing-tools/test-backfill-endpoints.js                    # Test locally (http://localhost:8888)
 *   node scripts/testing-tools/test-backfill-endpoints.js https://contributor.info  # Test production
 */
