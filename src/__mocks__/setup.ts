...
// Mock Supabase to ensure tests don't require environment variables
// This is needed for CI environments where module resolution might differ
...
// Also mock the env module to provide test values
...
// Mock the @/lib/env alias path as well
vi.mock('@/lib/env', async () => {
  return {
    env: {
      SUPABASE_URL: 'https://test.supabase.co',
