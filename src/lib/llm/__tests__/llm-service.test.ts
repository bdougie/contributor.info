...
const mockOpenAIService = {
  ...
  generateHealthInsight: vi.fn() as MockedFunction<
    (healthData: unknown, repoInfo: { owner: string; repo: string }) => Promise<LLMInsight | null>
  >,
  generateRecommendations: vi.fn() as MockedFunction<
    (_data: unknown, repoInfo: { owner: string; repo: string }) => Promise<LLMInsight | null>
  >,
  analyzePRPatterns: vi.fn() as MockedFunction<
    (prData: unknown[], repoInfo: { owner: string; repo: string }) => Promise<LLMInsight | null>
  >,
};
