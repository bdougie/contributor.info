...
describe('Demo Data Cache', () => {
  ...
  describe('getCachedAnalyticsData', () => {
    it('should generate data on first call', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('🔄 Generating fresh analytics data for demo workspace');
    });
  ...
  describe('getCachedWorkspaceRepositories', () => {
    it('should generate data on first call', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('🔄 Generating fresh workspace repositories for demo workspace');
    });
  ...
  describe('getCachedRepositories', () => {
    it('should generate data on first call', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('🔄 Generating fresh repositories list for demo workspace');
    });
  ...
  describe('getCachedWorkspaceMetrics', () => {
    ...
    it('should generate metrics on first call', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('🔄 Generating fresh metrics for demo workspace (30d)');
    });
    ...
    it('should cache metrics per time range and repo selection', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('🔄 Generating fresh metrics for demo workspace (7d)');
    });
  ...
  describe('getCachedWorkspaceTrendData', () => {
    const mockRepos = [{ id: '1' }, { id: '2' }] as any[];
    ...
    it('should generate trend data on first call', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('🔄 Generating fresh trend data for demo workspace (30 days)');
    });
  ...
  describe('clearDemoDataCache', () => {
    it('should clear all cached data', () => {
      ...
      getCachedAnalyticsData();
      getCachedRepositories();
      getCachedWorkspaceMetrics([{ id: '1' }] as any[], '30d');
