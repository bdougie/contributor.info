...
export const githubOrganizationSchema = z.object({
  ...
  email: z.string().email().nullable().optional(),
  twitter_username: z.string().nullable().optional(),
  html_url: z.string().url('Invalid HTML URL').nullable().optional(),
  created_at: z.string().datetime('Invalid created_at timestamp').optional(),
  updated_at: z.string().datetime('Invalid updated_at timestamp').optional(),
...
export const githubRepositorySchema = z.object({
  ...
  size: z.number().int().min(0, 'Repository size cannot be negative').optional(),
...
export const githubPullRequestSchema = z.object({
  ...
  commits: z.number().int().min(0, 'Commits count cannot be negative').optional(),
  additions: z.number().int().min(0, 'Additions count cannot be negative').optional(),
  deletions: z.number().int().min(0, 'Deletions count cannot be negative').optional(),
  changed_files: z.number().int().min(0, 'Changed files count cannot be negative').optional(),
