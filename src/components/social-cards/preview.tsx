  ...
  return (
    <div className="container mx-auto py-2 max-w-6xl">
      ...
      <div className="mb-4 text-sm text-muted-foreground">
        <p>Social cards are dynamically generated by our Fly.io service. Click "Open Full Size" to view at actual dimensions (1200x630px).</p>
        <p className="mt-2">Service Status: <a href={`${flyServiceUrl}/health`} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Check Health</a></p>
      </div>
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" asChild>
                <a href={`${flyServiceUrl}/social-cards/home`} target="_blank" rel="noopener noreferrer">
