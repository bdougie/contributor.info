    ...
    <div className="container mx-auto p-4 max-w-4xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Test and debug the GitHub sync functionality</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
            ...
            <AlertDescription>
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <span>Authentication: {isLoggedIn ? 'Logged in' : 'Not logged in'}</span>
                </div>
                {!isLoggedIn && (
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={trackRepository} variant="outline" disabled={!owner || !repo}>
              Track Repository
            </Button>
            ...
            <TabsContent value="response">
              {syncResponse && (
                <div className="bg-muted p-3 rounded-md">
                  <pre className="text-xs font-mono">{JSON.stringify(syncResponse, null, 2)}</pre>
                </div>
              )}
