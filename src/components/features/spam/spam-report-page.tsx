/**
 * Public spam report submission page
 * Issue #1622: Known Spammer Community Database
 */

import { useState, useEffect } from 'react';
import { useNavigate } from 'react-router';
import { ArrowLeft, AlertTriangle, CheckCircle, ExternalLink } from '@/components/ui/icon';
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={category} onValueChange={(v) => setCategory(v as SpamCategory)}>
                ...
                <SelectContent>
                  {Object.entries(SPAM_CATEGORIES).map(([key, { label, description: desc }]) => (
            ...
            {isLoggedIn ? (
              ...
              <Alert>
                <AlertDescription>
                  ...
                  <Button variant="link" className="px-1 h-auto" onClick={() => navigate('/login')}>
                    Sign in
                  </Button>
                  to track your reports and build reputation.
                </AlertDescription>
              </Alert>
            )}
            ...
            {rateLimit?.allowed && (
              <div className="text-xs text-muted-foreground">
                Reports remaining: {rateLimit.remaining_hourly}/hour, {rateLimit.remaining_daily}
                /day
              </div>
            )}
          ...
          <div className="mt-8 pt-6 border-t">
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              ...
              <li>
                <strong>Provide context:</strong> Descriptions help moderators verify reports faster
              </li>
              <li>
