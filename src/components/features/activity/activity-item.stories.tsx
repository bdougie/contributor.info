  ...
  args: {
    activity: {
      ...
      pullRequest: {
        ...
        number: 456,
        title:
          'This is a very long pull request title that should demonstrate how the component handles text truncation and responsive layout on different screen sizes',
