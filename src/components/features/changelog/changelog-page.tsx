...
export function ChangelogPage() {
  ...
  return (
    <>
      <ChangelogSEO date={changelogEntries[0]?.date} version={changelogEntries[0]?.version} />
              ...
              <div className="flex-1">
                ...
                <div className="mb-6 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    <a href="/changelog-rss.xml" className="text-primary hover:underline">
                      RSS
                    </a>{' '}
                    or{' '}
                    <a href="/changelog-atom.xml" className="text-primary hover:underline">
                      Atom
                    </a>{' '}
