...
export function PrivacyPolicyPage() {
  ...
  const privacySections = useMemo(() => [
    ...
    { id: "information-you-provide", title: "Information You Provide", level: 3 },
    { id: "information-we-collect-automatically", title: "Information We Collect Automatically", level: 3 },
    { id: "how-we-use-your-information", title: "How We Use Your Information", level: 2 },
    { id: "legal-basis-for-processing-gdpr", title: "Legal Basis for Processing (GDPR)", level: 2 },
    ...
    { id: "changes-to-this-policy", title: "Changes to This Policy", level: 2 },
      ...
      <div className="flex gap-8">
        <main className="flex-1 max-w-4xl">
          <article className="prose prose-gray max-w-none">
            ...
            <p>
              Contributor.info ("we", "our", or "us") is committed to protecting your privacy. 
            ...
            <p>
              ...
              Repository analytics data is retained for up to 3 years. You can request 
            ...
            <p>
              We send transactional emails necessary for the service. You can manage 
              your email preferences in your <a href="/settings">account settings</a>.
            </p>
            ...
            <ul>
              <li>Email: privacy@contributor.info</li>
              <li>GitHub: <a href="https://github.com/bdougie/contributor.info/discussions">Discussions</a></li>
            </ul>
