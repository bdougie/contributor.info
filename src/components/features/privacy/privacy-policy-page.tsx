      ...
      <div className="flex gap-8">
        <main className="flex-1 max-w-4xl">
          <article className="prose prose-gray max-w-none">
            ...
            <p>
              Contributor.info ("we", "our", or "us") is committed to protecting
              your privacy. This Privacy Policy explains how we collect, use,
              and share information about you when you use our service.
            </p>
            ...
            <ul>
              <li>
                GitHub account information (username, email, avatar) when you
                log in
              </li>
            ...
            <ul>
              ...
              <li>
                Send transactional emails (account confirmations, service
                updates)
              </li>
            ...
            <h2 id="legal-basis-for-processing-gdpr">
              Legal Basis for Processing (GDPR)
            </h2>
            <p>We process your personal data based on:</p>
            <ul>
              <li>
                <strong>Contract:</strong> To provide the services you've signed
                up for
              </li>
              <li>
            ...
            <ul>
              <li>
                Service providers (Supabase for authentication, Resend for
                emails)
              </li>
            ...
            <p>
              ...
              Repository analytics data is retained for up to 3 years. You can
            ...
            <p>
              We send transactional emails necessary for the service. You can
            ...
            <ul>
              ...
              <li>
                GitHub:{" "}
                <a href="https://github.com/bdougie/contributor.info/discussions">
                  Discussions
                </a>
              </li>
            </ul>
            ...
            <p>
              For GDPR-related inquiries, you can contact me.
              brian@dinnerpeople.app
            </p>
          </article>
        </main>
