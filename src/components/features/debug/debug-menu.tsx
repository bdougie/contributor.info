...
export function DebugMenu() {
  ...
  const groupedRoutes = debugRoutes.reduce(
    (acc, route) => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground">
            Public development tools and social media previews. For admin tools like analytics,
            performance monitoring, and bulk operations, visit{' '}
