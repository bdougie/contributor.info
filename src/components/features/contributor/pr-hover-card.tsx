...
const getStatusBadgeStyle = (state: string, merged_at: string | null | undefined) => {
  if (merged_at) return 'bg-purple-100 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400';
...
export function PrHoverCard({ pullRequest, role, children }: PrHoverCardProps) {
