...
: (
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Progress 
            value={mockStats.external_contribution_rate} 
            className="h-3"
          />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <div className="text-2xl font-semibold">
              {mockStats.external_contributors}
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="text-2xl font-semibold">
              {mockStats.internal_contributors}
            </div>
            <p className="text-xs text-muted-foreground">
              maintainers/owners
            </p>
...
const meta: Meta<typeof SelfSelectionRateStory> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Displays the self-selection rate showing the percentage of contributions from external vs internal contributors with trend analysis.'
      }
    }
  },
  argTypes: {
...
export const HighExternalContributions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'A healthy open source project with 75.5% external contributions, showing strong community engagement.'
      }
    }
  }
}
...
export const BalancedContributions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'A balanced project with roughly equal external (52.3%) and internal (47.7%) contributions.'
      }
    }
  }
}
...
export const LowExternalContributions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'A project with mostly internal contributions (81.8%), typical of company-internal or specialized projects.'
      }
    }
  }
}
...
export const WithUpwardTrend: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Shows a positive trend with external contributions increasing significantly (+12.4%).'
      }
    }
  }
}
