...
const mockRepositories: RepositoryOption[] = [
  ...
  },
  {
    ...
    activity_count: 98,
    last_activity: new Date(Date.now() - 18 * 60 * 60 * 1000).toISOString(),
    language: 'Rust',
  },
  {
    id: '10',
...
function RepositoryFilterWrapper(
  props: Omit<Parameters<typeof RepositoryFilter>[0], 'selectedRepositories' | 'onSelectionChange'>,
) {
  const [selected, setSelected] = useState<string[]>([]);
  return (
    <RepositoryFilter {...props} selectedRepositories={selected} onSelectionChange={setSelected} />
  );
}

function SingleRepositoryFilterWrapper(
  props: Omit<
    Parameters<typeof SingleRepositoryFilter>[0],
    'selectedRepository' | 'onSelectionChange'
  >,
) {
...
export const Default: Story = {
  render: () => <RepositoryFilterWrapper repositories={mockRepositories} />,
};
...
export const EmptyRepositories: Story = {
  render: () => (
    <RepositoryFilterWrapper repositories={[]} placeholder="No repositories available" />
  ),
};

export const Disabled: Story = {
  render: () => <RepositoryFilterWrapper repositories={mockRepositories} disabled={true} />,
};
...
export const ManyRepositories: Story = {
  render: () => {
    ...
    return <RepositoryFilterWrapper repositories={manyRepos} />;
  },
};

// Single Selection Stories
export const SingleSelection: Story = {
  render: () => <SingleRepositoryFilterWrapper repositories={mockRepositories} />,
};
