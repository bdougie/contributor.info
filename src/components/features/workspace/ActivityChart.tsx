                ...
                <div className="bg-popover text-popover-foreground rounded-md border shadow-md p-2">
                  ...
                  <div className="space-y-0.5 text-xs">
                    <div className="flex items-center gap-2">
                      <span className="text-green-600 dark:text-green-400">+{tooltipData.point.additions.toLocaleString()}</span>
                      <span className="text-muted-foreground">additions</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-red-600 dark:text-red-400">-{tooltipData.point.deletions.toLocaleString()}</span>
                      <span className="text-muted-foreground">deletions</span>
                    </div>
                    <div className="flex items-center gap-2 pt-1 border-t">
                      <span className="font-medium">{(tooltipData.point.additions + tooltipData.point.deletions).toLocaleString()}</span>
