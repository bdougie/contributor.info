...
export function ContributorConfidenceLearnMore({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'factors' | 'interpretation' | 'tips'>(
    'overview'
  );
  ...
  const factors = [
    {
      ...
      icon: Star,
      description:
        'Percentage of users who starred or forked your repository and later became contributors',
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Contributor Confidence measures how likely people who show interest in your
                  repository (by starring, forking, or commenting) are to return and make meaningful
                  contributions. It's a key indicator of your project's approachability and
                  community health.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700 text-sm">
                        High contributor confidence indicates your project is welcoming,
                        well-documented, and easy to contribute to. This leads to more sustained
                        community growth and better long-term project health.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'tips' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Here are specific actions you can take to make your project more approachable and
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm text-green-700">
                      ...
                      <li>
                        • Label issues with difficulty levels (beginner, intermediate, advanced)
                      </li>
