...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A vertically stacked set of interactive headings that reveal or hide sections of content.',
      },
    },
  },
  tags: ['autodocs'],
    ...
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="faq-1">
        ...
        <AccordionContent>
          ...
          with tags attached. Return shipping is free for defective items, otherwise customer 
      ...
      <AccordionItem value="faq-2">
        ...
        <AccordionContent>
          Standard shipping takes 3-7 business days. Express shipping (1-2 business days) 
          and overnight shipping options are available at checkout for an additional fee.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="faq-3">
        ...
        <AccordionContent>
          ...
          delivery times vary by destination. Customers are responsible for any customs 
          duties or taxes.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="faq-4">
        ...
        <AccordionContent>
          ...
          log into your account to view order status and tracking information.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
