...
export interface SheetOverlayProps extends ComponentPropsWithoutRef<typeof SheetPrimitive.Overlay> {
  ref?: Ref<ElementRef<typeof SheetPrimitive.Overlay>>;
}
...
export interface SheetTitleProps extends ComponentPropsWithoutRef<typeof SheetPrimitive.Title> {
  ref?: Ref<ElementRef<typeof SheetPrimitive.Title>>;
}
