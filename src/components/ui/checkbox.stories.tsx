...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A checkbox component for multiple selections. Built on Radix UI with indeterminate state support, keyboard navigation, and full accessibility.',
      },
    },
  },
      ...
      return (
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            State: {checked === 'indeterminate' ? 'Partially selected' : checked ? 'All selected' : 'None selected'}
          </p>
        </div>
      );
    };
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              { id: 'development', label: 'Development', description: 'Frontend and backend coding' },
...
export const ValidationStates: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: designTokens.spacing[4] }}>
      <div className="flex items-center space-x-2">
        <Checkbox id="valid" defaultChecked className="border-green-500 data-[state=checked]:bg-green-500" />
      ...
      <div className="flex items-center space-x-2">
        <Checkbox id="warning" defaultChecked className="border-amber-500 data-[state=checked]:bg-amber-500" />
        ...
        <CardContent className="space-y-4">
          {[
            ...
            <div key={item.id} className="flex items-start space-x-3 py-2">
              <Checkbox 
                id={item.id}
                className="h-5 w-5 mt-1 touch-manipulation"
              />
