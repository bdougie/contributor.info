...
const CircularProgress = React.forwardRef<HTMLDivElement, CircularProgressProps>(
  ({ 
    ...
    const backgroundPath = `M${size} ${halfSize}C${size} ${halfSize * 0.735} ${size * 0.8375} ${halfSize * 0.265} ${size * 0.6648} ${halfSize * 0.2927}C${size * 0.4919} ${halfSize * 0.1055} ${size * 0.2204} ${halfSize * 0.0000} ${halfSize} 0C${halfSize * 0.7796} ${halfSize * -0.0000} ${halfSize * 0.5082} ${halfSize * 0.1055} ${halfSize * 0.2927} ${halfSize * 0.2927}C${halfSize * 0.1055} ${halfSize * 0.4919} ${halfSize * 0.0000} ${halfSize * 0.7796} 0 ${halfSize}H${halfSize * 0.16}C${halfSize * 0.16} ${halfSize * 0.7769} ${halfSize * 0.2435} ${halfSize * 0.5529} ${halfSize * 0.4078} ${halfSize * 0.4078}C${halfSize * 0.5529} ${halfSize * 0.2435} ${halfSize * 0.7769} ${halfSize * 0.16} ${halfSize} ${halfSize * 0.16}C${halfSize * 1.2231} ${halfSize * 0.16} ${halfSize * 1.4471} ${halfSize * 0.2435} ${halfSize * 1.5922} ${halfSize * 0.4078}C${halfSize * 1.7565} ${halfSize * 0.5529} ${halfSize * 1.84} ${halfSize * 0.7769} ${halfSize * 1.84} ${halfSize}H${size}Z`;
    ...
    return (
      <div
        ref={ref}
        className={cn("relative w-[98px] h-[52px]", className)}
        {...props}
      >
