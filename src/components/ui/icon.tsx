...
export const ChevronsUpDown = (props: Omit<IconProps, 'name'>) => <Icon name="chevrons-up-down" {...props} />;
...
export const MoreHorizontal = (props: Omit<IconProps, 'name'>) => <Icon name="more-horizontal" {...props} />;
...
export const GripVertical = (props: Omit<IconProps, 'name'>) => <Icon name="grip-vertical" {...props} />;
...
export const CheckCircle2 = (props: Omit<IconProps, 'name'>) => <Icon name="check-circle-2" {...props} />;
...
export const GitPullRequest = (props: Omit<IconProps, 'name'>) => <Icon name="git-pull-request" {...props} />;
export const GitPullRequestDraft = (props: Omit<IconProps, 'name'>) => <Icon name="git-pull-request-draft" {...props} />;
...
export const HelpCircle = (props: Omit<IconProps, 'name'>) => <Icon name="help-circle" {...props} />;
...
export const TrendingDown = (props: Omit<IconProps, 'name'>) => <Icon name="trending-down" {...props} />;
