      ...
      try {
        ...
        segments.forEach((segment) => {
          ...
          const segmentEndAngle =
            segment.startAngle + (segment.endAngle - segment.startAngle) * segmentProgress;
  ...
  return (
    ...
    >
      ...
      <span id="donut-chart-description" className="sr-only">
        Use arrow keys to navigate between segments. Press Enter or Space to select a segment. Press
